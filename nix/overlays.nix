# nix/overlays.nix — Expose pkgs.anika-agent for external NixOS configs
#
...
# `pkgs.anika-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    anika-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
