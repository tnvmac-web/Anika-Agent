      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via ANIKA_BUNDLED_SKILLS /
            # ANIKA_OPTIONAL_SKILLS (see anika-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + ANIKA_BUNDLED_LOCALES
            # / ANIKA_OPTIONAL_MCPS, not via the wheel. Excluding them
