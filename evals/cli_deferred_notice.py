...
def run_case(root, output, name, behind, early=False, cancel=False):
    with tempfile.TemporaryDirectory(prefix="anika_test_notice_") as home:
        hh = Path(home) / ".anika"
        hh.mkdir()
        ...
        from anika_cli.banner import VERSION
        ...
        bootstrap = ("import anika_cli.main as m; import anika_cli.banner as b; "
        ...
        try:
            ...
            result = {"case": name, "ready": ready, "exited": exited,
                      ...
                      "loaded_worktree": str(root / "anika_cli/banner.py") in text,
