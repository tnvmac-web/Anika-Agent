...
benchmarked ten harnesses on hostile-file handling — and whose Anika column
...
Every task runs the full Anika agent (file + terminal + search toolsets)
...
Rules of engagement (from anikabench discipline):
