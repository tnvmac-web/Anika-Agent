...
Data file: $ANIKA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ANIKA_HOME = Path(os.environ.get("ANIKA_HOME", Path.home() / ".anika"))
DATA_DIR = _ANIKA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
