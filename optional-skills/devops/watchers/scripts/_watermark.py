...
def _state_dir() -> Path:
    ...
    # Default: $ANIKA_HOME/watcher-state/, falling back to ~/.anika/watcher-state/.
    anika_home = os.environ.get("ANIKA_HOME") or str(Path.home() / ".anika")
    return Path(anika_home) / "watcher-state"
