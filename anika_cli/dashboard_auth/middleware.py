...
from anika_cli.dashboard_auth import list_session_providers
...
from anika_cli.dashboard_auth.prefix import prefix_from_request
from anika_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
from anika_cli.dashboard_auth.request_utils import (
...
def _safe_next_target(request: Request) -> str:
    ...
    SPA's ``sessionStorage["anika.lastLocation"]``."""
...
_PLUGIN_COMPAT_LAZY = {
    'DashboardAuthProvider': ('anika_cli.dashboard_auth.base', 'DashboardAuthProvider'),
}
