...
``@__NEW_ORG__/ui`` design system; fonts load from the SPA's ``/fonts/``
...
<title>Sign in — Anika Agent</title>
<style>
  /* Brand fonts shipped by @__NEW_ORG__/ui — same files the SPA loads. */
  @font-face {{
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Anika Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Anika Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
See the <a href="https://anika-agent.__NEW_DOMAIN__/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
