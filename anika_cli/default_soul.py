"""Default SOUL.md template seeded into ANIKA_HOME on first run."""
...
DEFAULT_SOUL_MD = (
    "You are Anika Agent, built by __NEW_ORG__. Be direct: match the length of your reply to the weight of "
...
_SCAFFOLD_HEAD = (
    ...
    "The agent will embody whatever you write here.\nEdit this to customize how Anika communicates with you.\n\n"
)
_SCAFFOLD_TAIL = (
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are Anika Agent, an intelligent AI assistant created by __NEW_ORG__. You are helpful, "
