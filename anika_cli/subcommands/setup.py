...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure Anika Agent with an interactive wizard. "
        "Run a specific section: "
        "anika setup model|tts|terminal|gateway|tools|telemetry|agent")
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare 'anika setup' now does this.")
    setup_parser.add_argument(
    ...
    setup_parser.add_argument(
        ...
        help="One-shot __NEW_ORG__ Portal setup: log in via OAuth, pick a __NEW_ORG__ "
        "model, set __NEW_ORG__ as the inference provider, and opt into the Tool "
