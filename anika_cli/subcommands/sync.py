"""``anika sync`` subcommand parser — Skill Sync.
...
resolved __NEW_ORG__ token carries the access-gate claim AND a sync base URL is configured — the
...
def build_sync_parser(subparsers, *, cmd_sync: Callable) -> None:
    ...
    sync_parser = subparsers.add_parser(
        ...
        epilog="Examples:\n"
            "  anika sync status            what is synced, and from where\n"
            "  anika sync enable my-skill   include a skill in your sync\n"
            "  anika sync now               pull, then push\n"
            "  anika sync propose my-skill  share a skill with your team\n",
