...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Anika Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any anika CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--anika-root",
        help="Override the Anika source root used by Desktop (sets ANIKA_DESKTOP_ANIKA_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets ANIKA_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Anika Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Anika Local Signing)",
    )
