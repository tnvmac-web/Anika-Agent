"""Anika skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ANIKA_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ANIKA_CADUCEUS)
...
# Branding shared by every Anika-named built-in (mono/daylight override help_header).
_ANIKA_BRANDING: Dict[str, str] = _branding(
    "Anika", "⚕", "Goodbye! ⚕", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic Anika — gold and kawaii",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_ANIKA_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _ANIKA_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
