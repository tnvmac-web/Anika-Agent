...
reload / targeted unload unwind registries in reverse order. Mixed into :class:`anika_cli.plugins.PluginManager`.
"""
...
from anika_cli.plugins_loader import _plugin_home_scope
from anika_cli.plugins_manifest import PluginManifest, manifest_key
...
class PluginLedgerMixin:
    ...
    def _dispose_registrations(self, registrations: List[PluginRegistration]) -> None:
        ...
        from anika_cli.plugins import _PLUGINS_DEBUG
