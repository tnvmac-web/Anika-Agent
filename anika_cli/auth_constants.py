...
Pure leaf: imports nothing from ``anika_cli.auth`` so the per-provider modules
...
# httpx is imported lazily (~30ms) because anika_cli.auth is on the interactive-CLI startup path
...
if TYPE_CHECKING:
    ...
    class _LazyHttpx:
        ...
        # set/del forward to the real module so monkeypatch.setattr("anika_cli.auth.httpx.Client")
...
# __NEW_ORG__ Portal defaults
DEFAULT_NOUS_PORTAL_URL = "https://portal.__NEW_DOMAIN__"
DEFAULT_NOUS_INFERENCE_URL = "https://inference-api.__NEW_DOMAIN__/v1"
DEFAULT_NOUS_CLIENT_ID = "anika-cli"
...
try:  # Version tag for the Codex token-endpoint User-Agent; fall back if unavailable.
    from anika_cli import __version__ as _ANIKA_CLI_VERSION
except Exception:  # pragma: no cover - version import should always succeed
    _ANIKA_CLI_VERSION = "unknown"
CODEX_OAUTH_USER_AGENT = f"anika-cli/{_ANIKA_CLI_VERSION}"
...
SPOTIFY_DOCS_URL = "https://anika-agent.__NEW_DOMAIN__/docs/user-guide/features/spotify"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

OAUTH_OVER_SSH_DOCS_URL = "https://anika-agent.__NEW_DOMAIN__/docs/guides/oauth-over-ssh"
