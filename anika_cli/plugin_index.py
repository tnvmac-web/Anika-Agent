...
cached under ``ANIKA_HOME/cache/`` with a TTL, bundled seed as offline fallback / format reference.
...
DEFAULT_INDEX_URL = "https://raw.githubusercontent.com/__NEW_ORG__/anika-plugin-index/main/index.json"
...
def _cache_path() -> Path:
    return get_anika_home() / "cache" / "plugin_index.json"
