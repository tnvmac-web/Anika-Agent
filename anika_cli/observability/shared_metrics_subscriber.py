"""Relay subscriber for the persisted Anika shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Anika counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Anika shared metric: %s", metric_name, exc_info=True
                )
