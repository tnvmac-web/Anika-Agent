"""Persistent session goals — the Ralph loop for Anika.
...
# (schema DDL, FTS tables, first anika_cli.config import) measures ~300ms warm and more on slow
...
def _get_session_db() -> Optional[Any]:
    """Cached SessionDB per ANIKA_HOME (profile switches pick the right DB); None on any failure.
