"""Anika middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "anika.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "anika.middleware.v1"
...
def _apply_request_chain(
    ...
    from anika_cli.plugins import invoke_middleware
...
def apply_llm_request_middleware(request: Dict[str, Any], **context: Any) -> RequestMiddlewareResult:
    ...
    from anika_cli.plugins import has_middleware
