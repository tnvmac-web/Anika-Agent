...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Anika to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Anika needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Anika gateway in another terminal:",
        "         anika gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://anika-agent.__NEW_DOMAIN__/docs/user-guide/",
