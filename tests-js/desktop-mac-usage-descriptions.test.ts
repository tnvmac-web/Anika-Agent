 ...
 *
 * Each entry is a key/value pair that lands in the packaged Anika.app's
 ...
 * "Anika wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Anika wants to access Music" when Anika never touches the Music
