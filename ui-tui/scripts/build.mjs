...
await build({
  ...
  // Skip the prebuilt @anika/ink bundle and inline the source instead:
  ...
  alias: { '@anika/ink': resolve(root, 'packages/anika-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The anika_cli launcher
