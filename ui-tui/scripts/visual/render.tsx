 ...
 * across theme x background scenes to <tmpdir>/anika-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@anika/ink'
...
// The regenerated slate light_colors block from anika_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/anika-agent',
...
const setup = (bgHex: string) => {
  process.env.ANIKA_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
