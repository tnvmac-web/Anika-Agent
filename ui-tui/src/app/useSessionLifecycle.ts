...
import type { ScrollBoxHandle } from '@anika/ink'
import { evictInkCaches } from '@anika/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ANIKA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
