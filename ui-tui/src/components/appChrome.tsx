import { Box, type ScrollBoxHandle, stringWidth, Text } from '@anika/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ANIKA_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ANIKA_DEV_CREDITS), lowest priority,
