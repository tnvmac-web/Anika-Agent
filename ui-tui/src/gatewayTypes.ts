import type { BillingBlock, UsageModelData } from '@anika/shared/billing'
import type { AnikaSkin } from '@anika/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@anika/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = AnikaSkin
...
// Wire shapes now live in @anika/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
