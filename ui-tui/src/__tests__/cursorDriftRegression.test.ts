 ...
 *
 * Symptom: in `anika --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@anika/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using anika --tui and as i type multiline my caret at the end will often ' +
