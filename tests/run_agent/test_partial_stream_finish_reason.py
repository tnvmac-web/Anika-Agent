...
class TestCleanStreamEndMidToolCall:
    ...
    NO [DONE].  Observed live on NVIDIA Nemotron Ultra via the __NEW_ORG__ dedicated
...
class TestStreamIncludeUsageFinalChunk:
    ...
    Anika must recognize that the presence of usage proves the stream completed
