"""Regression guard: a genuine __NEW_ORG__ 429 must re-enter the retry loop so the
top-of-loop __NEW_ORG__ rate-limit guard can activate the fallback chain.
