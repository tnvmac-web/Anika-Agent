...
manipulation. Anika keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point ANIKA_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_anika_home /
    get_default_anika_root) instead of monkeypatching private helpers —
    ...
    ANIKA_HOME=<root>/profiles/<name> makes get_default_anika_root()
