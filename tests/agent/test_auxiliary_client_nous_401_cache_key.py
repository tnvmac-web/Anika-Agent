"""A __NEW_ORG__ 401 refresh must replace the auxiliary client under the SAME cache key
...
NOUS_BASE_URL = "https://inference-api.__NEW_DOMAIN__/v1"
...
async def test_async_call_llm_auto_provider_evicts_stale_client_end_to_end(monkeypatch):
    ...
    """
    task = "session_search"
    main_runtime = {"provider": "nous", "model": "Anika-4-405B"}
