...
thinking phase.  Anika's default cloud-stream stale detector
(``ANIKA_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ANIKA_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
