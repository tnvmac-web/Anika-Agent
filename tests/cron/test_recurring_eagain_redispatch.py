...
This file drives the REAL `tick()` end-to-end against a throwaway ANIKA_HOME:
...
def wedge_env(tmp_path, monkeypatch):
    ...
    script = anika_home / "scripts" / "probe.py"
    script.write_text("print('ok')\n")

    return {"home": anika_home, "job_id": job["id"]}
...
class TestEAGAINRecurringRedispatches:
    ...
    def test_eagain_then_redispatched_on_next_tick(self, wedge_env, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(S, "_anika_home", env["home"])
