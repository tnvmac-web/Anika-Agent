...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("anika_cli.config.get_config_path", return_value=config_path), \
             patch("anika_cli.config.ensure_anika_home"):
    ...
    def test_ensure_anika_home_sets_0700(self):
        home = Path(self.tmpdir) / ".anika"
        with patch("anika_cli.config.get_anika_home", return_value=home):
