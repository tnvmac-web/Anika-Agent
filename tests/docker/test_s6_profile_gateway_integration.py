...
The unit tests in tests/anika_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned anika-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/anika")
from anika_cli.service_manager import S6ServiceManager
