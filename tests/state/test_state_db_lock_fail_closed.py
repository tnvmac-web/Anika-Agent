...
work on a file several Anika processes share (gateway service, the Desktop
app's `anika serve` backend, CLI sessions, the TUI slash worker):

* `anika_state_common.fts_rebuild_admission` — full structural FTS rebuilds
* `anika_state_repair._cross_process_repair_lock`   — writable_schema surgery / VACUUM
