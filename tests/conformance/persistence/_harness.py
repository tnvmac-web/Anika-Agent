...
def make_anika_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated ANIKA_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"anika-home-{journal_mode}"
