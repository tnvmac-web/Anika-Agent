...
FIXTURE_NO_PROVIDER = (
    "agent init failed: No LLM provider configured. Run `anika model` to select "
    "a provider, or run `anika setup` for first-time configuration."
)
FIXTURE_NO_TOKEN = "agent init failed: No access token found for __NEW_ORG__ Portal login."
