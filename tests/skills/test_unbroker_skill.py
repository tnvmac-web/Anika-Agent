...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and anika-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # anika-agent (tests/skills/)
]
