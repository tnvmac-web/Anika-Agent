"""Tests for _setup_feishu() in anika_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("anika_cli.config.save_env_value", side_effect=mock_save), \
         patch("anika_cli.config.get_env_value", side_effect=mock_get), \
         patch("anika_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("anika_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("anika_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("anika_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("anika_cli.cli_output.print_header"), \
         patch("anika_cli.cli_output.print_info"), \
         patch("anika_cli.cli_output.print_success"), \
         patch("anika_cli.cli_output.print_warning"), \
         patch("anika_cli.cli_output.print_error"), \
