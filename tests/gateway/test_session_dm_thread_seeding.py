...
def store(tmp_path, monkeypatch):
    ...
    ~/.anika/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at anika_state import time, before pytest's ANIKA_HOME monkeypatch
    fires — the autouse fixture's ANIKA_HOME override doesn't help here.)
    """
    import anika_state
