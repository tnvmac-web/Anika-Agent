...
from anika_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/anika_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("anika_cli.lifecycle.invoke_hook")
@patch("anika_cli.lifecycle.finalize_session")
