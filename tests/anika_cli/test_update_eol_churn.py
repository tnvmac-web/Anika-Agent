"""Regression: ``anika update`` should take a managed checkout off autocrlf=true.
...
``anika update`` has to repair them.
...
from anika_cli.update_cmd import _normalize_managed_eol
