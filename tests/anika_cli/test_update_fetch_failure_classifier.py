"""Fetch-failure classification for `anika update` / `anika update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/__NEW_ORG__/anika-agent.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `anika update` sit on
    ...
    from anika_cli import update_cmd_git
