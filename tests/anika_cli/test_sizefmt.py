"""Tests for the shared byte formatter (anika_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from anika_cli.backup import _format_size as backup
    from anika_cli.checkpoints import _fmt_bytes as checkpoints
    from anika_cli.sizefmt import format_bytes as doctor
