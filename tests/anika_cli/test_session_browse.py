"""Tests for the interactive session browser (`anika sessions browse`).
...
from anika_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """anika sessions browse should be parseable."""
