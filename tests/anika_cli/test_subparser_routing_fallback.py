...
The main() function in anika_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `anika -c model`
...
def _build_parser():
    """Build a minimal replica of the anika top-level parser."""
