"""Tests for Blank Slate setup mode (anika_cli/setup.py).
...
from anika_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
