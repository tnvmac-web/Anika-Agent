"""Tests for the shared tar.gz writer (``anika_cli.archive_safe.make_targz``).

``make_targz`` backs both ``anika profile export`` and ``anika kanban
...
from anika_cli.archive_safe import make_targz
