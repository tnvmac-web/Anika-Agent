...
Profile-aware location: ``$ANIKA_HOME/logs/dashboard-auth.log``.
...
from anika_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $ANIKA_HOME and ~ to a tmp dir for the duration of the test."""
    home = tmp_path / ".anika"
    home.mkdir()
