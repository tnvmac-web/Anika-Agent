"""Tests for `anika chat --safe-mode` isolation."""
...
_VARS = ("ANIKA_SAFE_MODE", "ANIKA_IGNORE_USER_CONFIG", "ANIKA_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["ANIKA_SAFE_MODE"] == "1"
        assert os.environ["ANIKA_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["ANIKA_IGNORE_RULES"] == "1"
        return True
