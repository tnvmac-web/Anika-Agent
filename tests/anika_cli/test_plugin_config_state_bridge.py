...
def test_config_round_trip_uses_canonical_settings_namespace(
    ...
    ctx.set_config("api_url", r"C:\Users\Owner\Anika 🚀")
    ...
    assert settings == {
        "api_url": r"C:\Users\Owner\Anika 🚀",
        "retry": {"policy": {"attempts": 3, "enabled": True}},
    }
    assert ctx.get_config("api_url") == r"C:\Users\Owner\Anika 🚀"
...
"""
    env = dict(os.environ, ANIKA_HOME=str(isolated_home))
    processes = [
        subprocess.Popen(
