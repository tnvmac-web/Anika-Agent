...
class TestGetCopilotModelContext:
    ...
    @patch("anika_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("anika_cli.models._urlopen_model_catalog_request")
    ...
    @patch("anika_cli.models.fetch_github_model_catalog", return_value=[])
