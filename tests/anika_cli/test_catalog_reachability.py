...
Run before any catalog commit:
    ...
    ANIKA_TEST_NETWORK=1 scripts/run_tests.sh tests/anika_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("ANIKA_TEST_NETWORK"),
    reason="network test; set ANIKA_TEST_NETWORK=1 to run",
)
