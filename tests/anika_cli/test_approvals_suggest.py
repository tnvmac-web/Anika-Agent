"""Tests for ``anika approvals suggest`` (anika_cli/approvals_suggest.py).

Approval history in Anika is implied, not ledgered: the session DB
...
from anika_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
