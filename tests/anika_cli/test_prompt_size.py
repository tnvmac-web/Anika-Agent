"""Tests for the ``anika prompt-size`` diagnostic (issue #34667)."""
...
from anika_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(anika_home, memory_text="", user_text=""):
    mem_dir = anika_home / "memories"
...
def _seed_skill(anika_home, name, description):
    skill_dir = anika_home / "skills" / "demo" / name
