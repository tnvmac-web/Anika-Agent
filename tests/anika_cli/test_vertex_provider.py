...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (anika_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_anika_overlays():
    """anika_cli.providers.get_provider("vertex") backs
