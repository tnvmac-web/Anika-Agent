"""Tests for `anika secrets bitwarden token` / `anika secrets onepassword token`.
...
from anika_cli import onepassword_secrets_cli as op_cli
from anika_cli import secrets_cli as bw_cli
