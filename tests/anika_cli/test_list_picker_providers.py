...
import anika_cli.model_switch_providers as anika_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(anika_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("anika_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import anika_cli.models as hm
    import anika_cli.models_catalog_static as anika_cli_models_catalog_static
    from anika_cli import models_catalog_static
    ...
    monkeypatch.setattr(anika_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
