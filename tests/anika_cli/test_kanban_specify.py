"""Tests for the specifier module + `anika kanban specify` CLI surface.
...
from anika_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `anika kanban …` argparse surface directly."""
