"""Tests for `_can_open_graphical_browser()` in anika_cli.auth.

Guards the fix for the May 2026 report where `anika auth add xai-oauth`
...
from anika_cli.auth import _can_open_graphical_browser
