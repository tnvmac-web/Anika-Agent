"""Session <-> workspace grouping key (anika_state_sessions.workspace_key).

The key is what `anika sessions list --workspace` groups/filters on. It is a
...
import anika_state_sessions
from anika_state_sessions import workspace_key
