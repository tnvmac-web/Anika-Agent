...
Keeps the ACP server tests offline: ``AnikaACPAgent._build_model_state``
calls ``anika_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import anika_cli.inventory as inventory
