"""Regression test: anika update must not load cryptography eagerly."""
...
assert 'anika_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running anika update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so anika_cli is importable,
