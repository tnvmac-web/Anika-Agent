...
cd apps/desktop
XCURSOR_SIZE=24 ANIKA_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/anika-typing
# → /tmp/anika-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/anika-typing.before.heapsnapshot
# → /tmp/anika-typing.after.heapsnapshot
```
