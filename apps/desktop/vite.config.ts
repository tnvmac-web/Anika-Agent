...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\anika\anika-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@anika/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@anika/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@anika/shared': path.resolve(__dirname, '../shared/src'),
