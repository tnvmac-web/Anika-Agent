...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshAnikaPathTitle: string
      sshAnikaPathDesc: string
      sshAnikaPathPlaceholder: string
  ...
  commandCenter: {
    ...
    anikaActiveSessions: (version: string, count: number) => string
