...
export const en: Translations = {
  ...
  boot: {
    ready: 'Anika Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Anika settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Anika backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingAnikaDesktop: 'Starting Anika Desktop…'
    },
    errors: {
      backgroundExited: 'Anika background process exited.',
      backgroundExitedDuringStartup: 'Anika background process exited during startup.',
    ...
    failure: {
      ...
      cloudDownTitle: '__NEW_ORG__ Cloud agent is down',
      ...
      cloudDownHint:
        'The buttons below open the __NEW_ORG__ Portal (instance status and controls) and our Discord for support.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Anika backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateAnika: 'Update Anika',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Anika Desktop.',
    ...
    native: {
      ...
      inputBody: 'Anika is waiting for your response.',
      turnDoneTitle: 'Anika finished',
      turnDoneBody: '',
  ...
  billingBlock: {
    titleNous: 'Out of __NEW_ORG__ credits',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `anika debug share --nous` from a terminal, or `anika debug share --local` to print the report without uploading.',
    handoffLead: 'Pick up the discussion in:',
    links: {
      github: 'GitHub Issues',
      portal: '__NEW_ORG__ Portal Support',
      discord: 'Discord'
    }
  },
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Anika defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Anika backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Anika backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.anika/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Anika is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Anika asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Anika was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Anika was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Anika follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Anika can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Anika when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Anika walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Anika is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Anika, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Anika Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Anika runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Anika only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Anika',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Anika checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Anika configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Anika.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Anika gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Anika Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Anika Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Anika runtime managed by this app.',
      kindRemoteDesc: 'A Anika gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Anika Cloud account.',
      kindSshDesc: 'A Anika install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Anika manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Anika Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Anika backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset ANIKA_DESKTOP_REMOTE_URL and ANIKA_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Anika backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Anika backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Anika Cloud',
      cloudDesc: 'Sign in once to Anika Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Anika Cloud',
      cloudSignIn: 'Sign in to Anika Cloud',
      cloudSignedIn: 'Signed in to Anika Cloud',
      cloudNeedsSignIn: 'Sign in to Anika Cloud to discover the agents on your account.',
      ...
      cloudNoAgents: {
        ...
        linkText: '__NEW_ORG__ portal',
        after: ', then refresh.'
      },
      cloudRefresh: 'Refresh',
      cloudConnect: 'Connect',
      cloudConnecting: 'Connecting…',
      cloudDiscoverFailed: 'Could not load your Anika Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Anika Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Anika Cloud',
      cloudSignedOutMessage: 'Cleared the Anika Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /anika.',
      ...
      restartingMessage: 'Anika Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Anika ${version}` : ''}`,
      ...
      sshDesc:
        'Anika is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshAnikaPathTitle: 'Anika path (optional)',
      sshAnikaPathDesc: 'Full path to the remote anika binary. Blank = auto-detect.',
      sshAnikaPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Anika found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Anika runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Anika is not installed on the remote host. Install it there (curl -fsSL https://anika-agent.__NEW_DOMAIN__/install.sh | sh) or set the Anika path.',
      sshErrPlatform:
        'Unsupported remote platform. Anika Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Anika on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Anika. Review the exact configuration below — it comes from the link, not from Anika.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Anika starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Anika ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Anika runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Anika at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with a __NEW_ORG__ subscription — sign in to __NEW_ORG__ Portal to activate.',
      nousAuthNeededTitle: 'Sign in to __NEW_ORG__ Portal',
      nousAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to __NEW_ORG__ Portal.`,
      nousAuthSignIn: 'Sign in',
      nousAuthDoneTitle: '__NEW_ORG__ Portal connected',
      nousAuthDoneMessage: 'Your subscription backends are now active.',
      nousAuthFailed: '__NEW_ORG__ Portal sign-in did not complete',
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Anika browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via anika curator restore.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Anika builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Anika to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Anika to generate pets.',
      backgroundHint: 'You can close this — Anika will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Anika desktop' },
    ...
    anikaActiveSessions: (version, count) => `Anika ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@anika:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Anika you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://anika.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Anika environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Anika did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Anika will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Anika backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Anika. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Anika backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Anika...',
    placeholderReconnecting: 'Reconnecting to Anika…',
    ...
    attachUrlDesc: 'Anika will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Anika to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Anika…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Anika…',
    ...
    unsupportedMessage: 'This version of Anika can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Anika from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Anika will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Anika desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Anika updater takes over in its own window and reopens Anika automatically when it’s done. Please don’t reopen Anika yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Anika reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Anika reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Anika?',
    blockerBody:
      'Anika needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Anika',
    foreignBlockerBody:
      'Anika can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Anika can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Anika needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Anika Desktop',
    setupChoiceDesc:
      'Connect this app to a Anika gateway you already run, or install Anika locally on this computer.',
    connectExistingTitle: 'Connect to existing Anika',
    ...
    installLocalTitle: 'Install Anika locally',
    installLocalDesc: 'Download Anika, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Anika Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Anika',
    remoteSetupDesc: 'Enter your gateway URL. Anika Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Anika gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/anika',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Anika gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Anika Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Anika CLI or desktop instance is running. Stop any running Anika instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Anika Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Anika is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Anika…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Anika',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Anika at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Anika connects automatically',
    ...
    authorizeThere: 'Authorize Anika there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Anika there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid __NEW_ORG__ subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Anika Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Anika Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Anika will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Anika is restarting...',
      askRestart: 'Ask Anika to restart the server',
      lookingRestart: taskId => `Anika is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Anika is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Anika to open a page.',
      finishedRestarting: message => `Anika finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Anika could not restart the server.',
      stillWorking:
        'Anika is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Anika is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Anika gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.anika/config.yaml). Anika won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Anika needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Anika needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Anika Desktop to use Save Image.',
    restartToSaveImages: 'Restart Anika Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `anika gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Anika loads when the work calls for them.'
      },
      messaging: {
        title: 'Anika away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Anika made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Anika — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
