...
import type { AnikaPlugin, PaletteContribution } from '@anika/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@anika/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: AnikaPlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:
