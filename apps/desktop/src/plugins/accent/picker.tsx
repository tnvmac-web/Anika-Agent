...
// __NEW_ORG__ 263°) sits in a few degrees you cannot reliably hit in HSV. In OKLCH the
...
const SWATCHES: ReadonlyArray<{ hex: string; name: string }> = [
  { hex: '#0053FD', name: '__NEW_ORG__ blue · 263° (light seed)' },
  { hex: '#4a84fe', name: '__NEW_ORG__ blue · 263° (dark seed)' },
