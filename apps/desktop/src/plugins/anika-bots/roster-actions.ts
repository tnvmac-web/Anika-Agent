...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@anika/plugin-sdk'
 ...
 *  (anika-agent#90102) and are discarded. Without `canonical_session` (older
