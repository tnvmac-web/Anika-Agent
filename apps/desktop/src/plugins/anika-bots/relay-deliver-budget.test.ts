...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/anika-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'anika_cli/config_defaults.py'), 'utf8')
