...
// (#73044). Exercises the REAL anika + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/anika')
...
const conn = (over: Partial<AnikaConnection> = {}): AnikaConnection =>
  ({
    authMode: 'oauth',
