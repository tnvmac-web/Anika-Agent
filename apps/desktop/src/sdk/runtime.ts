 ...
 * plugins resolve `@anika/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __ANIKA_PLUGIN_SDK__: sdk,
  __ANIKA_REACT__: React,
  __ANIKA_REACT_JSX__: jsxRuntime,
  __ANIKA_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@anika/plugin-sdk': shimUrl('__ANIKA_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__ANIKA_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__ANIKA_REACT_JSX__'),
    react: shimUrl('__ANIKA_REACT__')
  }
