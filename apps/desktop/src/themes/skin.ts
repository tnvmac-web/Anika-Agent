/**
 * Anika skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$ANIKA_HOME/skins/` (or a
 * built-in) resolved by `anika_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Anika authors from a prompt lights up all three surfaces from one file.
 *
...
import type { AnikaSkin, SkinColors } from '@anika/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: AnikaSkin): DesktopTheme | null {
