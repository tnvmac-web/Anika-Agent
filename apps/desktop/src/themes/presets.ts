...
/**
 * __NEW_ORG__ — the canonical Anika desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Anika's own: a VS Code theme carries no font opinion, and
...
/**
 * __NEW_ORG__ — the canonical Anika desktop identity: GitHub's chrome carrying Nous
...
export const nousTheme: DesktopTheme = {
  name: 'nous',
  label: 'Nous',
  description: 'GitHub chrome, __NEW_ORG__ blue accent',
  colors: {
    background: '#ffffff',
    foreground: '#1f2328',
    card: '#f6f8fa',
...
/**
 * __NEW_ORG__ Alt — the hand-authored __NEW_ORG__ from before the GitHub fork. Light is
 * glass neutrals with brand blue; dark is cream on mission-blue.
 */
export const nousAltTheme: DesktopTheme = {
  name: 'nous-alt',
  label: '__NEW_ORG__ Alt',
