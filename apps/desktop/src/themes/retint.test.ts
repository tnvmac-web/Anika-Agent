...
describe('themeHue', () => {
  it('reads the accent hue that ships', () => {
    // __NEW_ORG__ blue. Both palettes sit at this hue — light seeds `#0053fd` and dark
...
describe('retintTheme', () => {
  ...
  // The real motivating case: __NEW_ORG__ blue is legible on GitHub's light sidebar
