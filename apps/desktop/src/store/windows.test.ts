...
function installBridge(
  openSessionWindow?: Window['anikaDesktop']['openSessionWindow'],
  openWindow?: Window['anikaDesktop']['openWindow'],
  openBrowserWindow?: Window['anikaDesktop']['openBrowserWindow']
) {
