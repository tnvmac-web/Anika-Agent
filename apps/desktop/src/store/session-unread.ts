...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('anika.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('anika.desktop.unreadFinishedSessions')
