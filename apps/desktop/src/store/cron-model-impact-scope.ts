...
function identityForConnection(connection: AnikaConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: AnikaConnection | null): void {
