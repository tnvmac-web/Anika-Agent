...
const POPOUT_STORAGE_KEY = 'anika.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'anika.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'anika.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'anika.desktop.composerPopout.position'
