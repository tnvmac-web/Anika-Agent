...
export interface PetInfo {
  ...
  // the Anika "run" activity state uses the in-place running row).
 ...
 * ANIKA_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'anika.desktop.pet-roam.v1'
