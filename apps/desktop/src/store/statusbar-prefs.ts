...
// v1 (`anika.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'anika.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'anika.desktop.statusbarHidden'
// v1 (`anika.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'anika.desktop.statusbarVisible.v2'
