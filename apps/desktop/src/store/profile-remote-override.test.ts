...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://anika.example.com:8443/x')).toBe('anika.example.com:8443')
    expect(remoteHostLabel('https://anika.example.com:443')).toBe('anika.example.com')
    expect(remoteHostLabel('http://anika.example.com:80')).toBe('anika.example.com')
  })
