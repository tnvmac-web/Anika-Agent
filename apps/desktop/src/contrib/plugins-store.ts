 ...
 * `<anika home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'anika.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'anika.desktop.disabledPlugins.v1'
