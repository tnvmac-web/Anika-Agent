...
import { getLatestSessionMessages, type ProfileScope } from '@/anika'
...
interface BackgroundSyncParams {
  ...
  refreshAnikaConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshAnikaConfig])
}
