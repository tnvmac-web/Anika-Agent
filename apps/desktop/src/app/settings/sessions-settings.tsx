...
import type { AnikaConfigRecord, SessionInfo } from '@/types/anika'
...
// / Program Files), which buried any files Anika wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.anikaDesktop` is
    ...
    const settings = window.anikaDesktop?.settings
