...
export const FALLBACK_PORTAL_BILLING_URL = 'https://portal.__NEW_DOMAIN__/billing'
export const FALLBACK_PORTAL_URL = 'https://portal.__NEW_DOMAIN__'
  ...
  if (!billing.logged_in || subscription?.logged_in === false) {
    return {
      notice: {
        ...
        message: 'Run /portal in the TUI or open the __NEW_ORG__ portal to connect your account.',
