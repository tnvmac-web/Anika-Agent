...
describe('BillingSettings', () => {
  ...
  it('renders logged-out as a connect card without normal account rows', async () => {
    ...
    expect(await screen.findByText('Connect your __NEW_ORG__ account')).toBeTruthy()
    expect(screen.getByText('Run /portal in the TUI or open the __NEW_ORG__ portal to connect your account.')).toBeTruthy()
