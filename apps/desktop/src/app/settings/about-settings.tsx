...
const RELEASE_NOTES_URL = 'https://github.com/__NEW_ORG__/anika-agent/releases'
const INSTALLER_URL = 'https://anika-agent.__NEW_DOMAIN__/'
              ...
              <div className="min-w-0">
                {version?.bundleSwapPending ? (
                  ...
                  <>
                    ...
                    <Button
                      className="mt-2"
                      onClick={() => void window.anikaDesktop?.relaunchApp?.()}
                      size="sm"
                      variant="textStrong"
                    >
                    ...
                    <Button asChild className="mt-2" size="sm" variant="textStrong">
                      <a
                        ...
                        onClick={event => {
                          ...
                          void window.anikaDesktop?.openExternal?.(INSTALLER_URL)
                        }}
                        rel="noreferrer"
                        target="_blank"
                      >
          ...
          <div className="mt-3 flex flex-wrap items-center gap-4">
            ...
            <Button asChild className="ml-auto" size="sm" variant="text">
              <a
                ...
                onClick={event => {
                  event.preventDefault()
                  void window.anikaDesktop?.openExternal?.(RELEASE_NOTES_URL)
                }}
                rel="noreferrer"
                target="_blank"
              >
