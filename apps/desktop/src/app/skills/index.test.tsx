...
import type * as AnikaApi from '@/anika'
...
vi.mock('@/anika', async importOriginal => ({
  ...(await importOriginal<typeof AnikaApi>()),
...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'anika-skill-pick', name: 'web-research', identifier: 'web-research' },
          origin: 'https://anika-agent.__NEW_DOMAIN__'
        })
      )
    })
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { anikaDesktop?: unknown }).anikaDesktop = { connections, getAgentRoster }
