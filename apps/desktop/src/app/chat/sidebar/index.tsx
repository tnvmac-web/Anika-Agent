...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/anika'
...
// highlight markers (sqlite snippet() delimiters — see anika_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('anika:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('anika:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Anika to
