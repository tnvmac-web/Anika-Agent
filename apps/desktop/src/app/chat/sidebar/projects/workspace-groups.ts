...
import type { ProjectInfo, SessionInfo } from '@/anika'
 ...
 * repo shows its branches/worktrees even when they have no Anika sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: AnikaGitWorktree[]
): SidebarSessionGroup[] {
