...
import type { AnikaGitBranch } from '@/global'
...
const branchActionLabel = (branch: AnikaGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<AnikaGitBranch[]>([])
  ...
  const convert = async (branch: AnikaGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
