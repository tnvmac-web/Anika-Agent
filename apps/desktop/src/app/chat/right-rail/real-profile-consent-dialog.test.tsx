...
vi.mock('@/anika', () => ({
  saveAnikaConfigRecord: (config: Record<string, unknown>, profile?: unknown) => mocks.save(config, profile)
}))

const promptCopy = {
  title: 'Stay signed in to your sites',
  body: 'Let Anika browse with a snapshot of your default browser profile.',
...
vi.mock('../../hooks/use-config-record', () => ({
  anikaConfigCacheWriter: () => (config: Record<string, unknown>) => mocks.cache(config),
  useAnikaConfigRecord: () => ({ data: mocks.loadedConfig })
}))
