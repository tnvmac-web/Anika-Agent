...
const FOCUS_EVENT = 'anika:composer-focus'
const INSERT_EVENT = 'anika:composer-insert'
const ATTACH_IMAGES_EVENT = 'anika:composer-attach-images'
const INSERT_REFS_EVENT = 'anika:composer-insert-refs'
const SUBMIT_EVENT = 'anika:composer-submit'
const VOICE_TOGGLE_EVENT = 'anika:composer-voice-toggle'
const MODEL_MENU_EVENT = 'anika:composer-model-menu'
