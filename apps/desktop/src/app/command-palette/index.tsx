...
import { getAnikaConfigRecord, listAllProfileSessions } from '@/anika'
...
// Anika session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-anika',
            keywords: ['update', 'upgrade', 'anika', 'version', 'system', 'restart'],
            label: cc.updateAnika,
