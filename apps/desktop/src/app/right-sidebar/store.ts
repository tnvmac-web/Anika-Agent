...
const TAKEOVER_KEY = 'anika.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Anika can't clear via the API — the user
 *  sees exactly what runs instead of Anika silently deleting their creds. */
