import type { AnikaReviewFile } from '@/global'
...
export function buildReviewFlatList(files: AnikaReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: AnikaReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
