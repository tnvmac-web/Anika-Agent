...
import type { ModelOptionsResponse, SessionInfo } from '@/types/anika'
 ...
 *
 * Only the leading status prefix (e.g. "Anika is thinking...") and the
 ...
 *  resolved comment as JSON (AnikaPrComment shape); a malformed payload falls
