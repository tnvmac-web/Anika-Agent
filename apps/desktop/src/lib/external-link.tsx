...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|anika):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.anikaDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.anikaDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Anika, and it is the surface the agent
