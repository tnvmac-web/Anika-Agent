...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/anika-agent')).toBe('~/www/anika-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/anika-agent')).toBe('anika-agent')
    expect(pathLeaf('~/www/anika-agent')).toBe('anika-agent')
