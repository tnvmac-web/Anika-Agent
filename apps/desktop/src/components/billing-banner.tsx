 ...
 * usable — it only offers recovery: __NEW_ORG__ opens Settings → Billing in-app, other
...
export function BillingBanner({ sessionId }: { sessionId: null | string }) {
  ...
  const title = block.is_nous ? copy.title__NEW_ORG__ : copy.titleProvider(block.provider_label)
