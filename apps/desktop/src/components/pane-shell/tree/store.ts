...
const STORAGE_KEY = 'anika.desktop.layoutTree.v2'

writeKey('anika.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('anika.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('anika.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'anika.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'anika.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'anika.desktop.hiddenStripTabs.v1'
...
writeKey('anika.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ANIKA_LAYOUT_TREE__ = {
    close: closeTreePane,
