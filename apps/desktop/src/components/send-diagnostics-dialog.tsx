...
//               discussion: GitHub Issues · __NEW_ORG__ Portal Support · Discord.
...
const SUPPORT_LINKS = [
  { key: 'github', url: 'https://github.com/__NEW_ORG__/anika-agent/issues' },
  { key: 'portal', url: 'https://portal.__NEW_DOMAIN__/help' },
  { key: 'discord', url: 'https://discord.gg/__NEW_ORG__' }
] as const
