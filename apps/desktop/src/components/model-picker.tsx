...
import { getLocalModelsStatus } from '@/anika'
...
import type { LocalModelLoadProgress, ModelOptionProvider, ModelPricing } from '@/types/anika'
...
export function ModelPickerDialog({
  ...
  // the `anika model` CLI picker, which shows the curated list verbatim.
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // free_tier is only set for __NEW_ORG__. true → "Free tier", false → "Pro".
  const tierBadge =
