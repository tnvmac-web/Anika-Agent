...
export const ANIKA_CONTEXT_MENU_TRIGGER_ATTR = 'data-anika-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-anika-context-menu-trigger="" />
  )
}
