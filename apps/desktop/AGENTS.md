...
How to build Anika Desktop well. This is a judgment guide, not an inventory —
...
- The **backend** is authoritative for anything another Anika surface can also
...
- A **runtime home change** (switching the underlying `ANIKA_HOME` profile) is
...
its shape. "Plugin" means several unrelated things across Anika — do not assume
