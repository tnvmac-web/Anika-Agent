 ...
 * (`persist:anika-remote-oauth`) — the jar was keyed on the auth *mode*, not
 ...
 * setup: one box, two dashboards) fought over the same `anika_session*`
 ...
 *     cascade deliberately shares one jar with the __NEW_ORG__ Portal session.
...
export const LEGACY_OAUTH_PARTITION = 'persist:anika-remote-oauth'
