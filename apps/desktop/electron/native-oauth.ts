 ...
 * Apps) login to a gated Anika gateway: system-browser + loopback redirect +
 ...
 * upstream IDP (__NEW_ORG__ Portal) issues a per-gateway-instance client_id and only
...
// anika_cli/web_server.py status handler.
