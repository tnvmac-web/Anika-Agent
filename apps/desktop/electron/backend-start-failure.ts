 ...
 * startAnika() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startAnika() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startAnika`, re-emits
