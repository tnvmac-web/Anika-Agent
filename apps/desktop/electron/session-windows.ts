...
// by main.ts (`setBackgroundThrottling` driven by the merged `anika:active-work`
...
// (the "Anika idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Anika" wake word has NO preceding click,
