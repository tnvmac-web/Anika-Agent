...
// even though a fresh shell — and the Anika CLI — sees it immediately. The
// desktop's ANIKA_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\anika. Reading
...
//       ANIKA_HOME    REG_SZ    F:\Anika\data
//
