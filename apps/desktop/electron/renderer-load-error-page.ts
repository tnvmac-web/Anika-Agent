 ...
 *
 * 1. TORN BUNDLE after an update (#95575): `anika update` replaces the app
...
export interface RendererLoadErrorDetails {
  ...
  /** Repair command hint, e.g. `anika desktop --force-build`. */
  repairHint?: string
  /**
...
export function buildRendererLoadErrorPage(details: RendererLoadErrorDetails = {}): string {
  ...
  const title = 'Anika couldn\u2019t start the desktop UI'
  ...
  const repair = details.repairHint ? `<p>Repair with: <code>anika desktop --force-build</code></p>` : ''
...
<main>
  ...
  <code>anika desktop --force-build</code>, then restart the app.</p>
