/**
 * Canonical Anika skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$ANIKA_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`anika_cli/skin_engine.py`),
 ...
 *   • CLI     → `anika_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
