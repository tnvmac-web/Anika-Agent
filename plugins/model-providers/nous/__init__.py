"""__NEW_ORG__ Portal provider profile."""
...
class NousProfile(ProviderProfile):
    """__NEW_ORG__ Portal — product tags, reasoning with Nous-specific omission."""
    ...
    def build_extra_body(self, *, session_id: str | None = None, **context) -> dict[str, Any]:
        ...
        # __NEW_ORG__ Portal inference rejects caller-supplied provider routing prefs
    ...
    def _cannot_disable_reasoning(model: str | None) -> bool:
        ...
        try:
            from anika_cli.models_reasoning_caps import nous_model_reasoning_capabilities, warm_nous_reasoning_caps_async
...
nous = NousProfile(
    name="nous", aliases=("nous-portal", "__NEW_ORG__"), env_vars=("NOUS_API_KEY",),
    display_name="__NEW_ORG__", description="__NEW_ORG__ — Anika model family",
    signup_url="https://__NEW_DOMAIN__/", fallback_models=("anika-3-405b", "anika-3-70b"),
    base_url="https://inference-api.__NEW_DOMAIN__/v1", auth_type="oauth_device_code",
)
