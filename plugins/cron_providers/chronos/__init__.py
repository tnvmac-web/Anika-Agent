...
Holds no scheduler credentials — speaks only to NAS ``agent-cron`` endpoints with the __NEW_ORG__ token.
...
class ChronosCronScheduler(CronScheduler):
    ...
    def is_available(self) -> bool:
        ...
        __NEW_ORG__ login; otherwise the resolver falls back to the built-in ticker."""
