...
__NEW_ORG__ modifications: pattern data unchanged from upstream; the upstream RuleId
telemetry table (Claude Code PostToolUse metrics) is dropped — Anika has no consumer.
Anika-side wiring lives in __init__.py.
"""
