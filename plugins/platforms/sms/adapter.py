...
class SmsAdapter(BasePlatformAdapter):
    """Twilio SMS <-> Anika: one session per inbound number; replies always from TWILIO_PHONE_NUMBER."""
...
# anika_cli/gateway.py, and the _send_sms dispatch in tools/send_message_tool.py. TWILIO_*
