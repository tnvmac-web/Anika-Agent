 ...
 *
 * Plugins call window.__ANIKA_PLUGINS__.register(name, Component)
...
} from "@__NEW_ORG__/ui/ui/components/dialog";
...
import { Card, CardHeader, CardTitle, CardContent } from "@__NEW_ORG__/ui/ui/components/card";
import { Input } from "@__NEW_ORG__/ui/ui/components/input";
import { Label } from "@__NEW_ORG__/ui/ui/components/label";
import { Separator } from "@__NEW_ORG__/ui/ui/components/separator";
import { Tabs, TabsList, TabsTrigger } from "@__NEW_ORG__/ui/ui/components/tabs";
 ...
 * Exposed at runtime as ``window.__ANIKA_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ANIKA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ANIKA_PLUGIN_SDK__ = {
    ...
    // window.__ANIKA_SESSION_TOKEN__ directly.
    authedFetch,
    ...
    // UI components — __NEW_ORG__ DS where available, shadcn/ui primitives elsewhere.
    components: {
      Card,
      CardHeader,
      CardTitle,
