 ...
 * `window.__ANIKA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Anika brand in the top bar
 ...
 *  `window.__ANIKA_PLUGINS__.registerSlot(...)`.
 *
