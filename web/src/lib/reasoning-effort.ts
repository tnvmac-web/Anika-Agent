 ...
 *
 * Values mirror anika_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Anika default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Anika' default when unset). */
