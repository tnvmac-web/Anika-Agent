...
const STORAGE_KEY = "anika-dashboard-theme";
...
const FONT_STORAGE_KEY = "anika-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `anika_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "anika-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-anika-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-anika-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. __NEW_ORG__ Blue) doesn't leave its values behind when the user
