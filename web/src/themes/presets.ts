 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `anika_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Anika Teal",
  description: "Classic dark teal — the canonical Anika look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Anika Teal (Large)",
  description: "Anika Teal with bigger fonts and roomier spacing",
