...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateAnika: string;
    updateAnikaConfirmMessage?: string;
    updateAnikaConfirmNow?: string;
    updateAnikaConfirmTitle?: string;
    updatingAnika: string;
  ...
  // ── Achievements plugin (plugins/anika-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
