...
import {
  ...
  CardHeader,
  CardTitle,
} from "@__NEW_ORG__/ui/ui/components/card";
...
const PROVIDER_GROUPS: { prefix: string; name: string; priority: number }[] = [
  // __NEW_ORG__ Portal first
  { prefix: "NOUS_", name: "__NEW_ORG__ Portal", priority: 0 },
  // Then alphabetical by display name
  { prefix: "ANTHROPIC_", name: "Anthropic", priority: 1 },
  { prefix: "DASHSCOPE_", name: "DashScope (Qwen)", priority: 2 },
  { prefix: "ANIKA_QWEN_", name: "DashScope (Qwen)", priority: 2 },
...
// Mirror of the backend env-name guard (anika_cli/config.py _ENV_VAR_NAME_RE).
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-1">
          <p className="text-sm text-muted-foreground">
            {t.env.description} <code>~/.anika/.env</code>
          </p>
