...
import { ListItem } from "@__NEW_ORG__/ui/ui/components/list-item";
import { Segmented } from "@__NEW_ORG__/ui/ui/components/segmented";
...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    anika_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__anika_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id, rowProfile(id)), {
          ...
          headers: {
            "X-Anika-Session-Token":
              (window as unknown as { __ANIKA_SESSION_TOKEN__?: string })
                .__ANIKA_SESSION_TOKEN__ ?? "",
          },
        });
