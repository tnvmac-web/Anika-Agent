 ...
 * OAuth gate (Phase 7 of .anika/plans/2026-05-21-dashboard-oauth-auth.md).
 *
 * Renders nothing in loopback / --insecure mode. In gated mode, fetches
 * /api/auth/me on mount and surfaces:
 *
 *   - the user_id (truncated to 14 chars + ellipsis) since the __NEW_ORG__ Portal
...
export function AuthWidget({ className }: AuthWidgetProps) {
  ...
  const gated =
    typeof window !== "undefined" && !!window.__ANIKA_AUTH_REQUIRED__;
