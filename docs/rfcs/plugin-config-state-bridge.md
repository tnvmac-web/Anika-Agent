...
or change arbitrary Anika configuration.
...
small host fact requested by the RFC. Settings writes use Anika'
...
`ANIKA_HOME`, so one globally loaded plugin context follows multiplexed
...
```text
<ANIKA_HOME>/plugin-data/<plugin-data-namespace>/state.json
```
...
The implementation is covered with real temporary-Anika-home tests for:
...
- [Issue #64227](https://github.com/__NEW_ORG__/anika-agent/issues/64227)
- [RFC PR #58542](https://github.com/__NEW_ORG__/anika-agent/pull/58542) by Topher Ross
