#!/usr/bin/env python3
"""Build the Anika Skills Index — a centralized JSON catalog of all skills.
...
`anika skills search/install` can use it without hitting the GitHub API.
...
# Ensure ANIKA_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building Anika Skills Index...", flush=True)
