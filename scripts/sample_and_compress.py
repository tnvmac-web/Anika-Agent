...
DEFAULT_DATASETS = [
    "__NEW_ORG__/swe-terminus-agent-glm-kimi-minimax",
    "__NEW_ORG__/anika-agent-megascience-sft1",
    "__NEW_ORG__/Anika-Agent-Thinking-GLM-4.7-SFT2",
    "__NEW_ORG__/Anika-Agent-Thinking-GLM-4.7-SFT1",
    "__NEW_ORG__/terminal-tasks-glm-anika-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "__NEW_ORG__/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload __NEW_ORG__/{output_name} {final_output}")
