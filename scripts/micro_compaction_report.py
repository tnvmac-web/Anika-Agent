#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Anika logs.
...
With no LOGFILE, reads ``$ANIKA_HOME/logs/agent.log`` (default ~/.anika).
...
def default_log() -> Path:
    home = os.environ.get("ANIKA_HOME") or str(Path.home() / ".anika")
