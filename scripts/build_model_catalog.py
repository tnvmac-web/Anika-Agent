#!/usr/bin/env python3
"""Build the Anika Model Catalog — a centralized JSON manifest of curated models.
...
Anika CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Anika release.
...
# Ensure ANIKA_HOME is set for imports that touch it at module level.
os.environ.setdefault("ANIKA_HOME", os.path.join(os.path.expanduser("~"), ".anika"))

from anika_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "anika-agent repo",
            "docs": "https://anika-agent.__NEW_DOMAIN__/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Anika '
            ...
            "nous": {
                "metadata": {
                    "display_name": "__NEW_ORG__ Portal",
                    "note": (
