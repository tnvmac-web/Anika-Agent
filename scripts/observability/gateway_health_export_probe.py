...
def main() -> None:
    ...
    anika_home = Path(tempfile.mkdtemp(prefix="anika-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "anika-gateway-smoke",
    ...
    print(json.dumps({"anika_home": str(anika_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
