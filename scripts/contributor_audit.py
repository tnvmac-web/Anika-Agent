...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Anika\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (anika-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@__NEW_DOMAIN__",
    "cursoragent@cursor.com",
    "anika@__NEW_DOMAIN__",
    "anika-audit@example.com",
    "nousbot@__NEW_DOMAIN__",
    "anika@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
