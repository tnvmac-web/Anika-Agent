...
| [`anika-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-anika-agent) | Use, configure, theme, extend, and orchestrate Anika Agent. | `autonomous-ai-agents\anika-agent` |
...
| [`anika-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-anika-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\anika-agent-skill-authoring` |
| [`inspecting-anika-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-anika-desktop-dom) | Read the live Anika desktop DOM/CSS over CDP. | `software-development\inspecting-anika-desktop-dom` |
