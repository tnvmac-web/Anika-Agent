...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `anika_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `anika_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Anika Plugin](plugins/index.md) |
...
| Session storage | `anika_state.py`, `anika_state_*.py` | [Session Storage](session-storage.md) |
