...
description: "How the Anika Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Anika Desktop app connects to a **gated gateway** (a hosted or
...
For Anika specifically, native sign-in means:
...
```
Desktop app                Gateway (/auth/native/*)          __NEW_ORG__ Portal (IDP)
...
- [Run Anika with __NEW_ORG__ Portal](./run-anika-with-nous-portal.md)
