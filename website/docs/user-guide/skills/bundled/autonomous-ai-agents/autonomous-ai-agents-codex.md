...
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`anika-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-anika-agent) |
...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Anika terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Anika itself, `model.provider: openai-codex` uses Anika-managed Codex
OAuth from `~/.anika/auth.json` after `anika auth add openai-codex`. For the
...
## Anika Gateway Caveat

When invoking the Codex CLI from a Anika gateway/service context (for example,
