...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Anika Agent |
| License | MIT |
...
```
SCRIPT=~/.anika/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.anika/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
