...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/finance/3-statement-model` |
...
See [references/formulas.md](https://github.com/__NEW_ORG__/anika-agent/blob/main/optional-skills/finance\3-statement-model/references/formulas.md) for all formula details.
