...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`anika-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-anika-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Anika Agent via the native MCP client. This is the preferred
...
Then configure Anika Agent to connect via HTTP:
