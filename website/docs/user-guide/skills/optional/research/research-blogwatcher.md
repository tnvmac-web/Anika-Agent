...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/research/blogwatcher` |
...
## Working with Anika tools (read this first)

`blogwatcher-cli` is the feed database; Anika tools do the automation around it:
