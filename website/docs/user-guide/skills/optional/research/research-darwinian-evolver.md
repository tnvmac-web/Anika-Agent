...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research\darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Anika Agent |
| License | MIT |
...
import upstream classes into Anika itself.
...
```bash
mkdir -p ~/.anika/cache/darwinian-evolver && cd ~/.anika/cache/darwinian-evolver
...
```bash
cd ~/.anika/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.anika/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.anika/skills/research/darwinian-evolver
DE_DIR=~/.anika/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Anika core.
   Custom driver scripts under `~/.anika/skills/...` are user-side and fine.
