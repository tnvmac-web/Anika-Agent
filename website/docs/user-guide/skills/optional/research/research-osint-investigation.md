...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | Anika Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $ANIKA_OSINT_CACHE/icij/ (default: ~/.cache/anika-osint/icij/).
...
# Set ANIKA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
