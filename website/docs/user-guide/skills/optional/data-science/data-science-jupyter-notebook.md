...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing anika tool access (web_search, file ops). Stateless. |
