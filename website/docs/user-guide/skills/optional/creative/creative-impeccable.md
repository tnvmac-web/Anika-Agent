...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/creative/impeccable` |
...
> ships and verifies a Anika-native skill bundle under `.anika/skills/`.
> `anika skills install impeccable` pulls the current bundle live from that
