...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/creative/ascii-art` |
| Path | `optional-skills/creative\ascii-art` |
| Version | `4.0.0` |
| Author | 0xbyt4, Anika Agent |
| License | MIT |
...
```bash
python -m pyfiglet "ANIKA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ANIKA&font=Slant" | boxes -d stone
```
