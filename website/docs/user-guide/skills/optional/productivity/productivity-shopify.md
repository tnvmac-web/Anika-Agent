...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/productivity/shopify` |
...
4. Save to `${ANIKA_HOME:-~/.anika}/.env`:
   ```
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Anika","productType":"Apparel","tags":["test"]}}'
```
