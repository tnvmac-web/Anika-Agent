...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/web-development/page-agent` |
...
- User wants **Anika itself to drive a browser** → use Anika' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
