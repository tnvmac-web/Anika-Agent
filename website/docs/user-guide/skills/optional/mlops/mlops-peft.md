...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/mlops/peft` |
...
- **[Advanced Usage](https://github.com/__NEW_ORG__/anika-agent/blob/main/optional-skills/mlops\peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/__NEW_ORG__/anika-agent/blob/main/optional-skills/mlops\peft/references/troubleshooting.md)** - Common errors, debugging, optimization
