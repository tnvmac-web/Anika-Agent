...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development\subagent-driven-development` |
| Version | `1.1.0` |
| Author | Anika Agent (adapted from obra/superpowers) |
| License | MIT |
