...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/health/neuroskill-bci` |
...
Connect Anika to a running [NeuroSkill](https://neuroskill.com/) instance to read
