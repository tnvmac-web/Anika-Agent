...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain\evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Anika Agent |
| License | MIT |
...
Helper script path: `~/.anika/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.anika/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.anika/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.anika/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
