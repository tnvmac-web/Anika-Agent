...
| | |
|---|---|
| Source | Optional — install with `anika skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain\hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Anika Agent |
| License | MIT |
...
The script reads `${ANIKA_HOME:-~/.anika}/.env` for two optional defaults:
...
Helper script: `~/.anika/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.anika/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${ANIKA_HOME:-~/.anika}/.env`.
...
```bash
python ~/.anika/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.anika/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
