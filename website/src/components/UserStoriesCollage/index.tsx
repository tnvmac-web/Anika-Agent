  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Anika Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Anika &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Anika?{' '}
        <a
          href="https://github.com/__NEW_ORG__/anika-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/__NEW_ORG__" target="_blank" rel="noopener noreferrer">
          __NEW_ORG__ Discord
        </a>{' '}
