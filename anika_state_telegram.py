"""Telegram DM topic-mode mixin for :class:`anika_state.SessionDB`."""
...
from anika_state_common import _PREVIEW_ELIGIBLE_SQL, _PREVIEW_RAW_SELECT, _sql_session_last_active
...
class SessionTelegramTopicsMixin:
    ...
    def bind_telegram_topic(
        ...
        """Bind one Telegram DM topic thread to one Anika session. A session may be linked to
