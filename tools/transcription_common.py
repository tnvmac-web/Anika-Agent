...
LOCAL_STT_COMMAND_ENV = "ANIKA_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "ANIKA_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via anika_cli.models.deepinfra_base_url (shared).
