...
def _anydoc_missing_error(path: str) -> str:
    ...
    return (
        ...
        "firecrawl-anydoc` in Anika's environment, or convert the file "
...
def _hosted_ocr_config() -> tuple:
    ...
    is a direct ``FIRECRAWL_API_KEY`` (anydoc defaults api_url); the __NEW_ORG__ gateway's Parse proxy
