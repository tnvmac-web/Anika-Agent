...
# containing `cat ~/.anika/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `anika-agent-dev` skill contains a security postmortem mentioning `cat ~/.anika/.env`, which tripped
