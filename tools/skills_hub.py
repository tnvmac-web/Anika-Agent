...
Used by anika_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "ANIKA_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"ANIKA_HOME": _anika_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'ANIKA_INDEX_TTL': ('tools.skills_hub_search', 'ANIKA_INDEX_TTL'),
    'ANIKA_INDEX_URL': ('tools.skills_hub_search', 'ANIKA_INDEX_URL'),
    'AnikaIndexSource': ('tools.skills_hub_official', 'AnikaIndexSource'),
