...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'unset\s+\w*(?:CLAUDE|CODEX|ANIKA|AGENT|OPENAI|ANTHROPIC)\w*', "env_var_unset_agent", "context"),
    ...
    (r'\$HOME/\.anika/\.env|\~/\.anika/\.env', "anika_env", "strict"),
    (rf'{_MODIFY}(?:AGENTS\.md|CLAUDE\.md|\.cursorrules|\.clinerules)', "agent_config_mod", "strict"),
    (rf'{_MODIFY}\.anika/(config\.yaml|SOUL\.md)', "anika_config_mod", "strict"),
