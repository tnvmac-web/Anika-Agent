...
def _transcribe_local_command(
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="anika-local-stt-") as output_dir:
            ...
            # Scrub Anika secrets from the child env (same policy as _run_command_stt).
            # Scrub Anika secrets from the child env (sibling path to #56332 / _run_command_stt — this
            ...
            _run_quiet(shlex.split(command), timeout=300, env=anika_subprocess_env(inherit_credentials=False))
