...
from anika_constants import get_anika_home_override, anika_home_key
...
def _get_cloud_provider() -> Optional[CloudBrowserProvider]:
    """Return the provider cached for the active Anika profile."""
    _bt = _origin()
    ...
    try:
        ...
        if isinstance(browser_cfg, dict) and "cloud_provider" in browser_cfg:
            ...
            if provider_key == "nous":
                # Managed "__NEW_ORG__ Subscription" is serviced by the Browser Use provider.
