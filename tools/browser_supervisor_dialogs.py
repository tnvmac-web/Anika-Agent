...
DIALOG_BRIDGE_HOST = "anika-dialog-bridge.invalid"
...
(() => {
  if (window.__anikaDialogBridgeInstalled) return;
  window.__anikaDialogBridgeInstalled = true;
  const ENDPOINT = "http://anika-dialog-bridge.invalid/";
