...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Anika session"),
        ...
        _cmd("status", "Show Anika session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Anika agent"),
        ...
        _cmd("update", "Update Anika Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Anika gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Anika session in it",
