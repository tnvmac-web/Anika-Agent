...
class WhatsAppBehaviorMixin:
    ...
    DEFAULT_REPLY_PREFIX: str = "⚕ *Anika Agent*\n────────────\n"
...
def resolve_whatsapp_bridge_dir() -> Path:
    ...
    try:
        ...
        pass
    if anika_home_bridge.exists():
        return anika_home_bridge
    try:
        anika_home_bridge.parent.mkdir(parents=True, exist_ok=True)
        shutil.copytree(install_bridge, anika_home_bridge, dirs_exist_ok=False)
        return anika_home_bridge
    except Exception:
        return install_bridge
