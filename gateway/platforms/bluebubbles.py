...
# `require_mention: true` without custom aliases uses Anika wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?anika\s+agent\b[,:\-]?", r"(?<![\w@])@?anika\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Anika defaults)."""
