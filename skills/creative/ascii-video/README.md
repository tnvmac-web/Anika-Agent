...
Built for [Anika Agent](https://github.com/__NEW_ORG__/anika-agent). Usable in any coding agent. Canonical source lives here; synced to [`__NEW_ORG__/anika-agent/skills/creative/ascii-video`](https://github.com/__NEW_ORG__/anika-agent/tree/main/skills/creative/ascii-video) via PR.
