/**
 * Anika desktop plugin template. Save as:
 *   <anika home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <anika home> is ~/.anika by default, or ~/.anika/profiles/<name>
 * when running a named profile (`anika -p <name>`). Run `anika doctor` (or
 ...
 * Only these imports resolve: @anika/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@anika/plugin-sdk'
