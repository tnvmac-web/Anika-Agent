...
Standard library only, so it runs in any Anika environment without an install
...
USER_AGENT = "anika-agent/1.0 (rss-feeds skill; +https://github.com/__NEW_ORG__/anika-agent)"
TIMEOUT = 20
NS = {
