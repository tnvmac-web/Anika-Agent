...
as the provider stream ends — concurrently with Anika' consumer thread, which may not have
...
class RelayChatAccumulator:
    ...
    def observe(self, chunk: Any) -> None:
        ...
        choice = choices[0] if choices else None  # Anika never requests n>1
    ...
    def finalize(self) -> dict[str, Any]:
        ...
        # "stop" also covers __NEW_ORG__ Portal ``lastOne`` usage frames, which carry no finish_reason.
