...
_SESSION_CWD: ContextVar = ContextVar("ANIKA_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Anika source tree, a
    legitimate workspace when developing Anika; fallback-directory policy lives in the caller."""
