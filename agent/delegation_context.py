...
A Anika process may itself be a Kanban dispatcher worker with ANIKA_KANBAN_* in
...
_DELEGATED_CHILD_CONTEXT: ContextVar[bool] = ContextVar("anika_delegated_child_context", default=False)
...
_NON_DISPATCHER_OWNED_CONTEXT: ContextVar[bool] = ContextVar("anika_non_dispatcher_owned_context", default=False)

DELEGATED_CHILD_ENV_MARKER = "ANIKA_DELEGATED_CHILD_CONTEXT"

KANBAN_ENV_KEYS: tuple[str, ...] = (
    "ANIKA_KANBAN_TASK", "ANIKA_KANBAN_RUN_ID", "ANIKA_KANBAN_WORKSPACE", "ANIKA_KANBAN_WORKSPACES_ROOT",
    "ANIKA_KANBAN_CLAIM_LOCK", "ANIKA_KANBAN_BOARD", "ANIKA_KANBAN_DB",
)
...
def is_dispatcher_owned_worker_context() -> bool:
    """The single predicate every ``ANIKA_KANBAN_*`` identity gate should use."""
